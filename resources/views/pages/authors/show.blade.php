                            ...
                            <div class="rounded-top d-flex flex-row text-white"
                                ...
                                <div class="container">
                                    <div class="ms-4 d-flex flex-column mt-1" style="width: 150px;">
                                        <img src="{{ url($author->avatar) }}" alt="Generic placeholder image"
                            ...
                            <div class="card-body p-4 text-black">
                                <div class="container">
                                    ...
                                    <div class="text-end">
                                        ...
                                        <a href="{{ route('app_bookcreate') }}" class="btn btn-primary mt-2">Ajouter un
                                            livre</a>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center mb-4">
                                        <p class="lead fw-normal mb-0">Livres recents</p>
                                        @if (count($books) > 5)
                                            <p class="mb-0"><a href="{{ route('app_books') }}"
                                                    class="text-muted">Afficher tous les livres</a></p>
                                        @endif
                                    </div>
                                    <div class="row">
